...
class input_jadwal3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_input_jadwal3)
        ...
        val lapanganName = findViewById<TextView>(R.id.lapangan3).text.toString() // Lapangan name
        val lanjutButton = findViewById<Button>(R.id.lanjut3)
        val timeGrid = findViewById<GridLayout>(R.id.btnjadwal)
        val menuIcon = findViewById<ImageView>(R.id.menuIcon3)

...
class input_jadwal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val lapanganName = findViewById<TextView>(R.id.lapangan1).text.toString() // Lapangan name
        val lanjutButton = findViewById<Button>(R.id.lanjut)
